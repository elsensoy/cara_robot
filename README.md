...
| **U9 — single-support balance** | `single_support.py`: swap the roll trim for a COM-feedback controller; 5 s hold + lateral-push sweep | ✅ **MET** — 5 s one-foot hold (COM drift 2.3 mm, tilt 2.8°), rejects ~1 N·100 ms toward swing / ~3 N toward stance; envelope bounded by the 22.5 mm foot half-width — a design finding |
