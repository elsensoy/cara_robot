...
| U5–U6 — ears, full regression | add each deliberately, one at a time, re-measure vs baseline | ⬜ morphology validation |
...
- **[`cara_description/docs/upper_body_notes.md`](cara_description/docs/upper_body_notes.md)** : the composed config hierarchy and the staged upper-body mass/inertia analysis (U1 torso, U2 head/neck, U3 electronics placement study, U4 passive arm masses) measured vs a frozen baseline
